...
def create_data(chosen_author, split = [0,0], min_words = sequence_length, verbose = False):
    """
    Input:
...
def run_model(author):
    ...
    print('Done data')
    output = train(author, train_data, valid_data, test_data, epochs = 5, return_results = True)
    print(output)
